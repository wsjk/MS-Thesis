...
global m1 m2 g a b h h2 W L g...
       ...
       maxstroke RipForce1 totalMB1 totalMB2 totalMB3...
       total463L totalSRDweight total_lanyard_weight check type switches horz
...
% b = (108/12)*conv; %Length of 463 Pallet (x-direction) [m]
% L = 24*conv; %Length of Platform for CH-53[m]
% W = 5.5*conv; %Width of Platform for CH-53 [m]

a = (88/12)*conv;  %Width of 463 MASTER Pallet (y-direction) [m] 
b = (108/12)*conv; %Length of 463 MASTER Pallet (x-direction) [m]
L = (320/12)*conv; %Length of Platform for CH-47 [m]
W = (92/12)*conv; %Width of Platform fir CH-47[m]
h = 4*conv;
...
RipForce1 = 44482; %Activation force of SRD [N]
