...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    m2 = (cargoweight(1,2))*4.4482216/9.81; %cargo mass [kg]
    % noMB1 = 18;
...
%         end
    ...
    if direction == 'long'
        maxlongD = max(x2-x1)
        longstroke = maxstroke(1)
        noMB1
    elseif direction == 'late'
        maxlatD = max(y2-y1)
        latstroke = maxstroke(1)
        noMB1
    end
           
end
      
    records(track,:) = [10000 horz vert longstroke latstroke noMB1...
        RipForce LL_type 2*totalweight 2*totallanyardweight 2*totalrestraintweight...
        min(v2-v1) maxlongD maxlatD type 4*noMB1]   
        track = track+1;
    save guidance.mat
