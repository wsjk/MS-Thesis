...
SRDy = W/2-lanyard*.3048*cos(vert*pi/180)*sin(horz*pi/180);
...
Oui = 1;
Non = 0;
% Ktotal = 1/(1/K1 + 1/Kkevlar); %stiffness of kevlar strap and SRD in series
% SRD = [ 
%  -SRDx  W/2  0  -b/2  SRDy  SRDz Ktotal*noMB1 RipForce1*noMB1 Oui;... 
%  -SRDx -W/2  0  -b/2 -SRDy  SRDz Ktotal*noMB1 RipForce1*noMB1 Oui;...
%   SRDx  W/2  0   b/2  SRDy  SRDz Ktotal*noMB1 RipForce1*noMB1 Oui;...
%   SRDx -W/2  0   b/2 -SRDy  SRDz Ktotal*noMB1 RipForce1*noMB1 Oui];
% SRD = [ 
%  -SRDx  W/2  0  -b/2  SRDy  SRDz K1*noMB1 RipForce1*noMB1 Oui;... 
%  -SRDx -W/2  0  -b/2 -SRDy  SRDz K1*noMB1 RipForce1*noMB1 Oui;...
%   SRDx  W/2  0   b/2  SRDy  SRDz K1*noMB1 RipForce1*noMB1 Oui;...
%   SRDx -W/2  0   b/2 -SRDy  SRDz K1*noMB1 RipForce1*noMB1 Oui];
